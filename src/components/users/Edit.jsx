...
<div className="row flex-nowrap">
 ...
 {errorBack && <p className="text-danger">{errorBack}</p>  }
  <form onSubmit={sendData}>
   <Input errors={errors} id={'username'} title={'user name'} value={user.name} type={'text'} name={'name'} changeData={changeData} />
   <Input errors={errors} id={'email'} title={'user email'} value={user.email} type={'email'} name={'email'} changeData={changeData} />
   <Input errors={errors} id={'password'} title={'user password'} value={user.password} type={'password'} customClass={'bg-success text-white'}
   name={'password'} changeData={changeData} />
 
  <div className="mb-3">
  <input type="submit" value="Add user" className="btn btn-primary w-100" />
</div>
</form>
     </div>
</div>
